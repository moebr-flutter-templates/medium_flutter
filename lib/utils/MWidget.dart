// import 'package:medium_flutter/model/MModel.dart';
// import 'package:medium_flutter/screen/MAudioArticlesScreen.dart';
// import 'package:medium_flutter/screen/MBecomeAMemberScreen.dart';
// import 'package:medium_flutter/screen/MDashBoardScreen.dart';
// import 'package:medium_flutter/screen/MInterestsScreen.dart';
// import 'package:medium_flutter/screen/MNewStoryScreen.dart';
// import 'package:medium_flutter/screen/MPostDetailsScreen.dart';
// import 'package:medium_flutter/screen/MProfileScreen.dart';
// import 'package:medium_flutter/screen/MReadingListScreen.dart';
// import 'package:medium_flutter/screen/MSettingScreen.dart';
// import 'package:medium_flutter/screen/MStatsScreen.dart';
// import 'package:medium_flutter/screen/MStoriesScreen.dart';
...
import 'package:medium_flutter/screens/MBecomeAMemberScreen.dart';
import 'package:medium_flutter/screens/MDashBoardScreen.dart';
import 'package:medium_flutter/screens/MInterestsScreen.dart';
import 'package:medium_flutter/screens/MNewStoryScreen.dart';
import 'package:medium_flutter/screens/MPostDetailsScreen.dart';
import 'package:medium_flutter/screens/MProfileScreen.dart';
import 'package:medium_flutter/screens/MReadingListScreen.dart';
import 'package:medium_flutter/screens/MSettingScreen.dart';
import 'package:medium_flutter/screens/MStatsScreen.dart';
import 'package:medium_flutter/screens/MStoriesScreen.dart';
import 'package:medium_flutter/utils/AppWidget.dart';
import 'package:medium_flutter/utils/MColors.dart';
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              24.height,
              Text('Become a member', style: secondaryTextStyle(size: 16, )).onTap(() {
                finish(context);
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  8.width,
                  commonCacheImageWidget(data.img, height: 80, width: 80, fit: BoxFit.cover).cornerRadiusWithClipRRect(6)
                ],
              ),
            ],
          ),
...
class CommonListForStories extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView.separated(
      separatorBuilder: (_, index) => Divider(color: viewLineColor, height: 0.5),
      itemCount: list!.length,
                    ...
                    children: [
                      ...
                      PopupMenuButton(
                        ...
                        onSelected: (dynamic val) {
                          if (val == 2) Text("Share package was here");
          ...
          child: Container(
            ...
            child: Container(
              ...
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  commonCacheImageWidget(data.img, height: 80, width: 80, fit: BoxFit.cover).cornerRadiusWithClipRRect(8),
                  16.width,
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
